...
func (l *Logger) SetLogLevel(lv logrus.Level) error {
	switch lv {
	...
	case logrus.DebugLevel:
		l.SetLevel(lv)
	default:
		return fmt.Errorf("Not Supported Log Level[ %d ]", lv)
	}
	return nil
}

// SetLogLevelByString set log level from string
func (l *Logger) SetLogLevelByString(lv string) error {
	switch lv {
