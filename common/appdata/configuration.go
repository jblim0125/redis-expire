...
type Configuration struct {
	...
	models.Configuration `yaml:",inline" json:",inline"` // User Definition Configuration
}
...
func CheckLogLevel(lv string) (int, error) {
	...
	default:
		return -1, fmt.Errorf("ERROR. Not Supported Log Level[ %s ]", lv)
	}
}
...
type ConnPool struct {
	MaxIdleCons int `yaml:"maxIdleCons" json:"maxIdleCons"`
	MaxOpenCons int `yaml:"maxOpenCons" json:"maxOpenCons"`
}
